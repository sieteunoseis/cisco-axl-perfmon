...
CucmSession.prototype.addPhone = function(jsonDATA, callback) {
	...
	(!jsonDATA.enableactivationid && this._version.version >= 12.5 ? '' : '<enableActivationID>' + jsonDATA.enableactivationid + '</enableActivationID>'))
...
CucmSession.prototype.addUser = function(jsonDATA, callback) {
	...
	(!jsonDATA.controlleddevice2 ? '' : '<device>' + jsonDATA.controlleddevice2 + '</device>') +
...
CucmSession.prototype.getPhone = function(name, callback) {
	var XML_ENVELOPE = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns="http://www.cisco.com/AXL/API/' + this._version.version + '"><soapenv:Header/><soapenv:Body><ns:getPhone>%s</ns:getPhone></soapenv:Body></soapenv:Envelope>'
	
	var XML_BODY = (!name ? '' : '<name>' + name + '</name>')
	...
	options.headers.SOAPAction += ' getPhone'
...
CucmSession.prototype.listPhoneActivationCode = function(phoneName, callback) {
	...
	options.headers.SOAPAction += ' listPhoneActivationCode'
